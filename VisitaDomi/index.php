	...
	<div id="pagina">
		...
		<div id="formulario">
			...
			<div class="coluna-esquerda">
				...
				<input type="text" id="id-visitado" name="idVisitado" class="campo-texto"required>
				...
				<input type="text" id="entregas" name="entregas" class="campo-texto"required>

				<label for="data-visita">Data da Visita:</label>
				<input type="date" id="data-visita" name="data" class="campo-texto"required>
			...
			<div class="coluna-direita">
				...
				<textarea id="motivo" name="motivoVisita" class="campo-texto-area"required></textarea>
